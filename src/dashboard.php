  ...
  <div class="bg-black-75">
    <div class="content content-top content-full text-center">
      <div class="py-3">
        ...
        <h2 class="h4 fw-normal text-white-75 mb-0">Welcome Admin, you have <a class="text-primary-light link-fx" href="orders.php">12 pending orders</a>.</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="bg-body-light border-bottom">
  <div class="content py-1 text-center">
    <nav class="breadcrumb bg-body-light py-2 mb-0">
      <a class="breadcrumb-item" href="dashboard.php">e-Commerce</a>
...
<div class="content">
  ...
  <div class="row">
    ...
    <!-- Orders -->
    <div class="col-md-6 col-xl-3">
      <a class="block block-rounded block-transparent bg-gd-dusk" href="orders.php">
        <div class="block-content block-content-full block-sticky-options">
          <div class="block-options">
            <div class="block-options-item">
  ...
  <!-- Chart.js Chart functionality is initialized in js/pages/dashboard.min.js which was auto compiled from _js/pages/dashboard.js -->
      ...
      <div class="block block-rounded block-mode-loading-refresh">
        ...
        <div class="block-content block-content-full">
          <div class="pull">
            ...
            <canvas id="js-chartjs-ecom-dashboard-earnings"></canvas>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="block block-rounded block-mode-loading-refresh">
        ...
        <div class="block-content block-content-full">
          <div class="pull">
            ...
            <canvas id="js-chartjs-ecom-dashboard-orders"></canvas>
          </div>
        </div>
      </div>
    </div>
          ...
          <table class="table table-borderless table-striped mb-0">
            ...
            <tbody>
              <?php for ($i = 1; $i < 11; $i++) { ?>
                <tr>
                  <td>
                    <a class="fw-semibold" href="order.php">ORD.<?php echo 1852 - $i; ?></a>
                  </td>
                  <td>
                    <?php $cb->get_tag(true, true); ?>
                  </td>
                  <td class="d-none d-sm-table-cell">
                    <a href="customer.php"><?php $cb->get_name(); ?></a>
                  </td>
        ...
        <div class="block-content block-content-full">
          <table class="table table-borderless table-striped mb-0">
            ...
            <tbody>
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.258</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.198</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.852</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.741</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.985</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.056</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.036</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.682</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.478</a>
                </td>
                <td>
              ...
              <tr>
                <td class="d-none d-sm-table-cell">
                  <a class="fw-semibold" href="product_edit.php">PID.952</a>
                </td>
                <td>
