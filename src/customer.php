...
<div class="bg-gd-dusk">
  <div class="bg-black-25">
    <div class="content content-top content-full text-center">
      <div class="mb-3">
        <a class="img-link" href="customer.php">
          <?php $cb->get_avatar(15, '', 64, 'img-thumb'); ?>
        </a>
      </div>
      <h1 class="h3 text-white fw-bold mb-2">
        Nhóm 1 <i class="fa fa-star text-white-75 ms-1"></i>
      </h1>
...
<div class="bg-body-light border-bottom">
  <div class="content py-1 text-center">
    <nav class="breadcrumb bg-body-light py-2 mb-0">
      ...
      <span class="breadcrumb-item active">Nhóm 1</span>
    </nav>
  </div>
</div>
<!-- END Breadcrumb -->
...
<div class="content">
      ...
      <table class="table table-borderless table-striped mb-0">
        ...
        <tbody>
          <?php for ($i = 1; $i < 4; $i++) { ?>
            <tr>
              <td>
                <a class="fw-semibold" href="product_edit.php">PID.<?php echo 425 - $i; ?></a>
              </td>
              ...
              <td>
                <a href="product_edit.php">Product #<?php echo 25 - $i; ?></a>
              </td>
              <td class="d-none d-md-table-cell">
                ...
                ?>
                <a href="products.php"><?php echo $be_ecom_cat[rand(0, 8)]; ?></a>
              </td>
      ...
      <table class="table table-borderless table-striped mb-0">
        ...
        <tbody>
          <?php for ($i = 1; $i < 6; $i++) { ?>
            <tr>
              <td>
                <a class="fw-semibold" href="order.php">ORD.<?php echo rand(100, 999); ?></a>
              </td>
              <td>
              ...
              <td class="d-none d-sm-table-cell">
                <a href="customer.php">John Smith</a>
              </td>
  ...
  <div class="block block-rounded">
    <div class="block-content">
      ...
      <form action="customer.php" method="POST" onsubmit="return false;">
        <div class="mb-2">
