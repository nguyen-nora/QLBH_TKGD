...
<div class="content">
  ...
  <div class="row items-push">
    ...
    <div class="col-lg-4">
      <a class="block block-rounded block-link-shadow text-center h-100 mb-0" href="customer.php">
      ...
      <div class="table-responsive">
        <table class="table table-borderless table-striped mb-0">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <a class="fw-semibold" href="product_edit.php">PID.263</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a class="fw-semibold" href="product_edit.php">PID.214</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a class="fw-semibold" href="product_edit.php">PID.358</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a class="fw-semibold" href="product_edit.php">PID.425</a>
              </td>
              <td>
