  ...
  <div class="bg-black-75">
    <div class="content content-top content-full text-center">
      <div class="py-3">
        ...
        <h2 class="h4 fw-normal text-white-75 mb-0">In <a class="text-primary-light link-fx" href="products.php">video game</a> category.</h2>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="col-md-5">
      ...
      <div class="block block-rounded">
        ...
        <div class="block-content block-content-full">
          ...
          <form class="dropzone" action="product_edit.php"></form>
        </div>
      </div>
      <!-- END Images -->
    </div>
...
<script>Codebase.helpersOnLoad(['jq-select2', 'jq-maxlength', 'js-ckeditor']);</script>
