...
<header id="page-header">
  ...
  <div class="content-header">
    ...
    <div class="space-x-1 d-flex align-items-center space-x-2">
      <!-- Logo -->
      <a class="link-fx fw-bold" href="dashboard.php">
        <i class="fa fa-fire text-primary"></i>
        <span class="fs-4 text-dual">Nhóm</span><span class="fs-4 text-primary">1</span>
      </a>
      <!-- END Logo -->
    ...
    <div class="space-x-1">
      ...
      <a class="btn btn-alt-primary px-3 d-none d-sm-inline-block" href="be_pages_dashboard.php" target="_blank">
        ...
        <span class="ms-1 d-none d-sm-inline-block">Xem trực tiếp</span>
      </a>
      <a class="btn btn-alt-success px-3" href="https://github.com/nguyen-nora">
        <i class="fa fa-shopping-bag opacity-50"></i>
        <span class="ms-1 d-none d-sm-inline-block">Xem Source tại</span>
      </a>
    </div>
    <!-- END Right Section -->
  </div>
